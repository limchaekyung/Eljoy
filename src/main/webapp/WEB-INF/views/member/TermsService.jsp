...
<head>
<style type="text/css">
	.chk{height:70px;width: 150px; background-color: #3366FF; border-radius: 5px;
		cursor: pointer;}
	.chk b{font-size: 15px; color: white;}
</style>
...
<body>
 ...
 <table width="1400" height="650" style="margin-left: auto; margin-right: auto;">
  <tr>
...
회원가입
- 이름, 생년월일, 성별, 아이디, 비밀번호, 별명, 연락처(메일주소, 휴대폰 번호), 가입인증정보
만14세 미만 아동 회원가입
- 이름, 생년월일, 성별, 법정대리인 정보, 아이디, 비밀번호, 연락처 (메일주소, 휴대폰 번호), 가입인증정보
단체아이디 회원가입
...
- 생성정보 수집 툴을 통한 수집
  ...
  <tr>
   <td align="center" valign="top">
    <button class="chk" onclick="chk()"><b>동의하고 회원가입</b></button>&nbsp;&nbsp;&nbsp;
    <button class="chk" onclick="nochk()"><b>동의하지 않음</b></button>    
   </td>
  </tr>
 </table>
